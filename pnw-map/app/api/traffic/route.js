...
export async function GET() {
  try {
    ...
    const url = `https://api.tomtom.com/traffic/services/4/incidentDetails?key=${API_KEY}&bbox=${lng-0.1},${lat-0.1},${lng+0.1},${lat+0.1}&fields={incidents{type,geometry,properties{iconCategory}}}`;
